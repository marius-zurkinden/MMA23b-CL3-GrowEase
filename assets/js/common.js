  ...
  if (form) {
    ...
    function validateForm() {
      ...
      if (vorname.value.trim() === "") {
        // Prüft, ob der Vorname leer ist.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
        showError(vorname, "Bitte gib deinen Vornamen ein."); // Zeigt Fehler, wenn der Vorname fehlt.
        isValid = false; // Formular ist ungültig.
        // Kommentar: Prüft eine Bedingung im JavaScript.
      } else if (!nameRegex.test(vorname.value.trim())) {
        // Prüft, ob der Vorname Zahlen oder Sonderzeichen enthält.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
      ...
      if (nachname.value.trim() === "") {
        // Prüft, ob der Nachname leer ist.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
        showError(nachname, "Bitte gib deinen Nachnamen ein."); // Zeigt Fehler, wenn der Nachname fehlt.
        isValid = false; // Formular ist ungültig.
        // Kommentar: Prüft eine Bedingung im JavaScript.
      } else if (!nameRegex.test(nachname.value.trim())) {
        // Prüft, ob der Nachname Zahlen oder Sonderzeichen enthält.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
      ...
      if (adresse.value.trim() === "") {
        // Prüft, ob die Adresse leer ist.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
        showError(adresse, "Bitte gib deine Adresse ein."); // Zeigt Fehler, wenn die Adresse fehlt.
        isValid = false; // Formular ist ungültig.
        // Kommentar: Prüft eine Bedingung im JavaScript.
      } else if (!addressRegex.test(adresse.value.trim())) {
        // Prüft, ob die Adresse Text und Zahl enthält und keine falschen Sonderzeichen hat.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
        showError(
          adresse,
          "Adresse braucht Text und Hausnummer. Nur Bindestrich ist erlaubt.",
        ); // Zeigt Fehler bei falscher Adresse.
        isValid = false; // Formular ist ungültig.
      }

      // Kommentar: Prüft eine Bedingung im JavaScript.
      if (postleitzahl.value.trim() === "") {
        // Prüft, ob die PLZ leer ist.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
        showError(postleitzahl, "Bitte gib deine PLZ ein."); // Zeigt Fehler, wenn die PLZ fehlt.
        isValid = false; // Formular ist ungültig.
        // Kommentar: Prüft eine Bedingung im JavaScript.
      } else if (!plzRegex.test(postleitzahl.value.trim())) {
        // Prüft, ob die PLZ genau 4 Zahlen hat.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
      ...
      // Kommentar: Prüft eine Bedingung im JavaScript.
      if (stadt.value.trim() === "") {
        // Prüft, ob die Stadt leer ist.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
        showError(stadt, "Bitte gib deine Stadt ein."); // Zeigt Fehler, wenn die Stadt fehlt.
        isValid = false; // Formular ist ungültig.
        // Kommentar: Prüft eine Bedingung im JavaScript.
      } else if (!cityRegex.test(stadt.value.trim())) {
        // Prüft, ob die Stadt Zahlen, Leerzeichen oder Sonderzeichen enthält.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
      ...
      if (telefon.value.trim() === "") {
        // Prüft, ob die Telefonnummer leer ist.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
        ...
        // Prüft, ob die Telefonnummer exakt im Format 041 000 00 00 ist.
        // Kommentar: Führt eine JavaScript-Anweisung aus.
    ...
    form.addEventListener("submit", function (event) {
      // Kommentar: Prüft eine Bedingung im JavaScript.
      if (!validateForm()) {
        // Prüft das Formular beim Absenden.
      ...
      // Kommentar: Prüft eine Bedingung im JavaScript.
      if (spinner) {
        // Prüft, ob der Spinner vorhanden ist.
